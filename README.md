...
This is an unofficial fork of the original [dom-to-image](https://github.com/tsayen/dom-to-image) created by [Anatolii Saienko](https://github.com/tsayen) who appears to have fallen off the face of the earth. The last commit to the original repository hasn't had a commit in over 3 years and there 43 open pull requests. Many of these pull requests solve common issues people have using the library and should be committed in some capacity. My goal with this project to modernize the dom-to-image package with transpiling using [babel](https://github.com/babel/babel) and a module bundler such as [webpack](https://github.com/webpack/webpack) or [rollup](https://github.com/rollup/rollup). This will allow me to update the code to use ES6 and later syntax such as [`async/await`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function), [`let`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let)/[`const`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/const), [arrow functions](), etc. while ensuring backwards compatibility. Additionally, I'd like to enforce code style choices using [eslint](https://github.com/eslint/eslint) with the [Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript) as well as [prettier](https://github.com/prettier/prettier).

## Installation

### NPM

`npm install @insomnia-dev/dom-to-image`
...
import domtoimage, {
  ...
  toBlob,
  toPixelData,
} from '@insomnia-dev/dom-to-image';

/* in ES 5 */
const domtoimage = require('@insomnia-dev/dom-to-image');
const { toPng, tpJpeg, toBlob, toPixelData } = domtoimage;
```
...
Chris Sandvik, Anatolii Saienko, Paul Bakaus (original idea)
